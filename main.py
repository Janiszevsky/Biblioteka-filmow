...
peaky_blinders = Series(36, 6,  "Peaky Blinders", 2013, 'drama', 0)
the_sinner = Series(32, 4, "The Sinner", 2017, 'drama/thriller', 0)
the_office = Series(201, 9, "The Office", 2005, 'comedy', 0)
ozark = Series(44, 4, "Ozark", 2017, 'drama/thriller', 0)
